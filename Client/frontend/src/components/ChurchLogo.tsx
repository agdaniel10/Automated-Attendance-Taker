export function ChurchLogo() {
  return (
    <div className="flex items-center gap-4">
      <div className="relative flex h-18 w-18 items-center justify-center overflow-hidden rounded-[1.75rem] border border-amber-200 bg-linear-to-br from-white via-amber-50 to-amber-100 shadow-[0_14px_28px_-20px_rgba(161,98,7,0.65)]">
