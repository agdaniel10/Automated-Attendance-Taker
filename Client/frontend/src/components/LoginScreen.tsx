...
export function LoginScreen({
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(255,248,232,0.9),_rgba(255,255,255,1)_42%),linear-gradient(180deg,_#fffdf8_0%,_#ffffff_100%)] px-4 py-8 text-slate-900">
      <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1.15fr_0.85fr]">
        <section className="relative overflow-hidden rounded-[2rem] border border-white/80 bg-white p-8 shadow-[0_30px_80px_-45px_rgba(148,163,184,0.85)]">
          <div className="absolute inset-x-0 top-0 h-36 bg-[radial-gradient(circle_at_top,_rgba(245,158,11,0.12),_transparent_68%)]" />
          <ChurchLogo />
          <div className="relative mt-10 max-w-2xl space-y-6">
            <div className="space-y-4">
              <p className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-700">
                White, calm, and operator-ready
              </p>
              <h2 className="font-['Baskerville','Palatino_Linotype','Book_Antiqua',Georgia,serif] text-4xl leading-tight tracking-tight text-slate-950 sm:text-5xl">
        ...
        <section className="rounded-[2rem] border border-slate-200/80 bg-white p-8 shadow-[0_24px_60px_-40px_rgba(15,23,42,0.45)]">
          ...
          <form className="mt-8 space-y-5" onSubmit={onSubmit}>
            ...
            <button
              ...
              type="submit"
              disabled={isSubmitting || !apiBaseUrl.trim() || !password.trim()}
            >
